...
printf "\n" &&
printf "${GRE}Script to download all prequisites to build Chromium...\n" &&
tput sgr0 &&
...
printf "\n" &&
printf "${YEL}Installing depot_tools, cloning Chromium repo, and creating Chromium directories...\n" &&
tput sgr0 &&
sleep 1 &&
...
printf "\n" &&
git clone --recursive https://github.com/Alex313031/chromium.git &&
...
printf "\n" &&
printf "${YEL}Running set_exec.sh in ~/Chromium...\n" &&
tput sgr0 &&
...
printf "\n" &&
printf "${YEL}Running trunk.sh in ~/Chromium...\n" &&
tput sgr0 &&
