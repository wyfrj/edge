...
This directory contains compiler configurations files and args.gn files for compiling Chromium with:
...
It also contains config files for MacOS and ChromiumOS/ChromiumOS.

([AVX](https://en.wikipedia.org/wiki/Advanced_Vector_Extensions) is the normal Chromium baseline default)
