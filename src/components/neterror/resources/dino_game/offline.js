...
/** @const */
/** const ARCADE_MODE_URL = 'Chromium Dino'; */
const ARCADE_MODE_URL = 'chrome://dino/';
const ARCADE_MODE2_URL = 'Chromium Dino Game';
...
Runner.prototype = {
  ...
  isArcadeMode() {
    ...
    const is_chromium_dino = IS_RTL ? document.title.indexOf(ARCADE_MODE2_URL) == 1
                                   : document.title === ARCADE_MODE2_URL;
    return is_chrome_dino || is_chromium_dino;
  },
