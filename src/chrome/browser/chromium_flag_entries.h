...
#ifndef CHROME_BROWSER_CHROMIUM_FLAG_ENTRIES_H_
#define CHROME_BROWSER_CHROMIUM_FLAG_ENTRIES_H_
    ...
    {"auto-dark-mode",
     "GTK Auto Dark Mode",
     "Enables Chromium to automatically change to Dark Mode according to the system GTK Theme.",
     kOsLinux, SINGLE_VALUE_TYPE("auto-dark-mode")},
#endif // BUILDFLAG(IS_LINUX)

    {"chromium-2024",
     "Enable Experimental Chromium 2024 (Th24) UI",
     ...
     kOsDesktop, FEATURE_VALUE_TYPE(features::kChromium2024)},
    {"restore-tab-button",
     "Restore Tab Button",
    ...
    {"force-disable-tab-outlines",
     ...
     "Force disables tab outline strokes. Chromium enables them by default, improving accessiblity in dark mode, incognito mode, and low contrast themes.",
     kOsDesktop, SINGLE_VALUE_TYPE("force-disable-tab-outlines")},
    {"disable-chromium-icons",
     "Disable Chromium Top Bar Icons",
     "Disables the custom colored top bar icons in Chromium, and restores the default grey Chromium icon colors.",
     kOsDesktop, SINGLE_VALUE_TYPE("disable-chromium-icons")},
    {"left-aligned-tab-search-button",
     "Left Aligned Tab Search Button",
     "The default placement of the tab search button was changed to the left of the tabstrip in M125, but Chromium has reverted this back "
...
//#if BUILDFLAG(IS_WIN)
    //{"transparent-tabs",
     //"Chromium Semi-Transparent Tabs UI",
...
//#endif // BUILDFLAG(IS_WIN)
    ...
    {"disable-chromium-dns-config",
     "Disable Chromium Custom DNS Config",
     "Disables the custom DNS configuration used by default in Chromium. Useful when this config breaks something, "
     "due to external apps or a non-standard system DNS config setting.",
     kOsDesktop, SINGLE_VALUE_TYPE("disable-chromium-dns-config")},
    //{"side-panel-journeys",
     //"Side Panel Journeys",
    ...
    {"force-high-contrast",
     ...
     "Enables high contrast mode for all Chromium instances.",
    ...
    {"download-shelf",
     ...
     "When enabled, the traditional download shelf is used instead of the download bubble in the toolbar. Chromium flag",
    ...
    {"keep-all-history",
     "Keep All History",
     "Retain All local browsing history. By default history older than 4 months is expired and purged. Chromium flag",
    ...
    {"vaapi-video-decode-linux-gl",
     ...
     "Enabled by default, but may break some configurations. Chromium flag.",
    ...
    {"vaapi-on-nvidia-gpus",
     ...
     "Requires `vdpau-va-driver` to be installed, and can be buggy. Chromium flag.",
     kOsLinux, FEATURE_VALUE_TYPE(media::kVaapiOnNvidiaGPUs)},
#endif // BUILDFLAG(IS_LINUX)

    {"gpu-no-context-lost",
     "No GPU Context Lost",
     "Inform Chromium's GPU process that a GPU context will not be lost in power saving mode, screen saving mode, etc. "
    ...
    {"media-router",
     ...
     "Media router is a component responsible for pairing Chromium to devices and endpoints, "
    ...
    {"disable-encryption",
     ...
     "This is used to enable portable user data directories. Enabled for Chromium Portable.",
     kOsDesktop, SINGLE_VALUE_TYPE("disable-encryption")},
    {"disable-machine-id",
     "Disable Machine ID",
     "Disables use of a generated machine-specific ID to lock the user data directory to that machine. This is used to enable portable user data directories. Enabled for Chromium Portable.",
    ...
    {"revert-from-portable",
     ...
     "When moving a Chromium user profile from one drive to another (or one system to another), enable this flag before moving the profile directory. It should also be used "
...
#endif  // CHROME_BROWSER_CHROMIUM_FLAG_ENTRIES_H_
