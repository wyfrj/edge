...
#include "components/password_manager/core/browser/password_manager_switches.h" // Needed for Chromium password-store flag
...
// Include Chromium Flags
#include "chrome/browser/chromium_flag_choices.h"
