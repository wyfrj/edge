...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("chromium");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chromium");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chromium");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chromium");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chromium");
#endif  // OS_*
