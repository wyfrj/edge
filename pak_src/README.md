## Chromium Pak Customizer

<img src="https://github.com/Alex313031/Chromium/blob/main/logos/STAGING/pak.png">
...
These are copied when running ./setup.sh during the Chromium build to the //chromium/src/out/Chromium dir for the installer to include.
