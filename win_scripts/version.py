...
# --help
def display_help():
    print(f"\nScript to check out Chromium tag of current Chromium version.\n")
...
print(f"\nCurrent Chromium version is: {thor_ver}\n")
...
copy(
    os.path.normpath(os.path.join(thor_src_dir, "Chromium-libjxl/src/DEPS")),
    os.path.normpath(os.path.join(cr_src_dir, "DEPS")),
)
copy(
    os.path.normpath(os.path.join(
        thor_src_dir, "Chromium-libjxl/src/.gitmodules")),
    os.path.normpath(os.path.join(cr_src_dir, ".gitmodules")),
)
copy(
    os.path.normpath(
        os.path.join(thor_src_dir, "Chromium-libjxl/src/third_party/.gitignore")
    ),
