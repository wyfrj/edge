...
mkdir C:\src\chromium\src\out\Chromium &&

echo "Copying Chromium source files over the Chromium tree..." &&
...
copy ..\src\Chromium_shell\* C:\src\chromium\src\out\Chromium &&
copy ..\src\pak_src\bin\pak-win\* C:\src\chromium\src\out\Chromium &&
