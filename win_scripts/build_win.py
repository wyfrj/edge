...
try_run(f'autoninja -C out/Chromium Chromium_all -j{jobs}')

try_run(f'autoninja -C out/Chromium setup mini_installer -j{jobs}')

installer_dest = os.path.normpath(os.path.join(cr_src_dir, 'out', 'Chromium'))
