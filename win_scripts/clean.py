...
deletes //out/Chromium and unneeded PGO files.
"""
...
def main():
    ...
    Chromium_dir = os.path.normpath(os.path.join(cr_src_dir, "out", "Chromium"))
    ...
    if cleanup_needed:
        ...
        dir_deleted = (
            delete_directory(Chromium_dir) if os.path.exists(
                Chromium_dir) else False
        )
