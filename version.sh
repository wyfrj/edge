...
printf "\n"
printf "${GRE}Current Chromium version is:${c0} ${underline}$THOR_VER${c0}\n"
printf "\n"
...
cp -v Chromium-libjxl/src/DEPS ${CR_SRC_DIR}/ &&
cp -v Chromium-libjxl/src/.gitmodules ${CR_SRC_DIR}/ &&
cp -v Chromium-libjxl/src/third_party/.gitignore ${CR_SRC_DIR}/third_party/ &&
