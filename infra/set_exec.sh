...
printf "\n" &&
printf "${GRE}Script to set chmod +x on all other Chromium scripts.\n" &&
tput sgr0 &&
printf "${BOLD}\n" &&
...
sudo chmod -v +x infra/DEBUG/Chromium_Debug_Shell.sh &&

sudo chmod -v +x logos/NEW/mac/gen/app/build_icns.sh &&

sudo chmod -v +x logos/NEW/mac/gen/document/build_icns.sh &&

sudo chmod -v +x infra/portable/Chromium-PORTABLE &&

sudo chmod -v +x infra/portable/Chromium-SHELL &&

sudo chmod -v +x infra/portable/Chromium-portable.desktop &&

sudo chmod -v +x infra/portable/Chromium-shell.desktop &&
