...
rm -r -v ./Chromium-PORTABLE &&
rm -r -v ./Chromium-SHELL &&
rm -f -v ./C/Chromium-PORTABLE.sh.x.c &&
rm -f -v ./C/Chromium-SHELL.sh.x.c &&

sleep 1s &&

shc -r -v -o ./Chromium-PORTABLE -f ./Chromium-PORTABLE.sh &&
shc -r -v -o ./Chromium-SHELL -f ./Chromium-SHELL.sh &&

# Move generated C files for possible future use
mv -f -v ./Chromium-PORTABLE.sh.x.c ./C/ &&
mv -f -v ./Chromium-SHELL.sh.x.c ./C/ &&
