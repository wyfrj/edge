### Dependencies to build Chromium on Ubuntu 22.04 "Jammy Jellyfish", since *//chromium/src/build/install-build-deps.sh* has not yet been updated.
...
Lastly, if you want ChromiumOS fonts for ChromiumOS development, you can run (as root)
