...
printf "\n" &&
printf "${YEL}Building Chromium UI Debug Shell for Linux...\n" &&
printf "${CYA}\n" &&
...
cd ${CR_SRC_DIR} &&
autoninja -C out/Chromium Chromium_ui_debug_shell minidump_stackwalk dump_syms -j$@ &&
...
cp -r -f -v Chromium_Debug_Shell.sh ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell &&
...
# cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libffmpeg.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libffmpeg.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/lib &&
# cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libblink_test_plugin.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
# cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libmojo_core.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
...
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libEGL.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libGLESv2.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libvk_swiftshader.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/libvulkan.so.1 ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
...
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/Chromium_ui_debug_shell ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/minidump_stackwalk ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/dump_syms ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/ClearKeyCdm ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/ &&
cp -r -f -v ${CR_SRC_DIR}/out/Chromium/ClearKeyCdm/_platform_specific/linux_x64/libclearkeycdm.so ${CR_SRC_DIR}/out/Chromium/Chromium_UI_Debug_Shell/lib &&
